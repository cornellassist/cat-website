  ...
  return (
    <div className="flex flex-col items-center gap-5">
      ...
      <Image src={HeroPic} alt="A Cornell Assistive Technology team work session" height={HeroPic.height} width={HeroPic.width}
        className="mt-5 h-80 origin-top scale:90 sm:scale-120 lg:scale-100 w-auto rounded-[20px] drop-shadow-[0_4px_4px_rgba(0,0,0,0.5)]" />
...
const HeroContainer = ({ children }: any) => {
  return (
    <div className="mt-24 universepad relative overflow-hidden h-150 sm:h-180 md:h-180 lg:h-155 xl:h-170 2xl:h-190">
