...
function LoginCard() {
  ...
  return (
    <div className="flex justify-center items-center h-full w-full">
      {/* card */}
      <div
        className="h-3/4 w-1/2 px-10 py-7 flex flex-col justify-between backdrop-blur-[2px] bg-theme-white/90 shadow-[0_1px_2px_rgba(0,0,0,0.06),0_12px_24px_rgba(0,0,0,0.08)]
    rounded-[20px]"
      >
      ...
      `}
        ...
        `}
            ...
            <span
              className={`w-5 h-5 shrink-0 ${false ? "opacity-[0.38]" : ""}`}
            >
              <svg
                viewBox="0 0 48 48"
