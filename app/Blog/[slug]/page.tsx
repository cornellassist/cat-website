...
export default async function Blog({ params }: Props) {
    ...
    return (
        ...
        <div className="w-full max-w-4xl rounded-2xl p-8 flex flex-col">
            ...
            <p className="font-bold">{blogPost.author.name} <span className="text-gray-500 font-normal">• {blogPost.publishDate.toLocaleDateString()}</span></p>
            </div>
            
            <p className="text-gray-900">{blogPost.content}</p>
